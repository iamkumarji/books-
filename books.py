...
while loop is True:
    ...
    if number == max:
        print("Retrieved", numberforcalc, "Books, out of the maximum of",
              max, "As of 31st August 2021")
        time.sleep(3)
        break
print("downloading", numberforcalc, "Books, out of the maximum of",
      max, "As of 31st August 2021")
time.sleep(1)
...
for link in links:
    ...
    if not os.path.isfile(filename):
        ...
        try:
            ...
            failed += 1
            filenum -= 1
print("Done Operation, Downloaded", filenum,
      "/", numberforcalc, "Last ID was", number)
